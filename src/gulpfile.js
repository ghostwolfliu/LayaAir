...
var packsDef = [
    {
        ...
        'out': '../' + build_path + '/js/libs/laya.core.js'
    },
    {
        'libName': "d3",
        'input': [
        ...
        'out': '../' + build_path + '/js/libs/laya.d3.js'
    },
    {
        ...
        'out': '../' + build_path + '/js/libs/laya.cannonPhysics.js'
    },

    {
        ...
        'out': '../' + build_path + '/js/libs/laya.device.js'
    },
    {
        'libName': 'tiledmap',
        'input': [
        ...
        'out': '../' + build_path + '/js/libs/laya.tiledmap.js'
    },
    {
        'libName': 'html',
        'input': [
        ...
        'out': '../' + build_path + '/js/libs/laya.html.js'
    },
    {
        'libName': 'particle',
        'input': [
        ...
        'out': '../' + build_path + '/js/libs/laya.particle.js'
    },

    {
        ...
        'out': '../' + build_path + '/js/libs/laya.physics.js'
    },
    {
        'libName': 'ui',
        'input': [
        ...
        'out': '../' + build_path + '/js/libs/laya.ui.js'
    },
    {
        'libName': 'ani',
        'input': [
        ...
        'out': '../' + build_path + '/js/libs/laya.ani.js'
    },//debugtool
    {
        'libName': 'debugtool',
        'input': [
        ...
        'out': '../' + build_path + '/js/libs/laya.debugtool.js'
    }
];
...
gulp.task('ConcatBox2dPhysics', function (cb) {
    pump([
        gulp.src([
            ...
            '../' + build_path + '/js/libs/laya.physics.js']),
        concat('laya.physics.js'),//合并后的文件名
        gulp.dest('../' + build_path + '/js/libs/'),
    ], cb);
});
...
gulp.task('CopyJSFileToTSCompatible', () => {
    return gulp.src([
        './layaAir/jsLibs/laya.physics3D.wasm.wasm', '../' + build_path + '/js/libs/**/*.js'])
        .pipe(gulp.dest('../' + build_path + '/ts/libs'));
});

//拷贝js库至as库
gulp.task('CopyJSFileToAS', () => {
    return gulp.src([
        './layaAir/jsLibs/laya.physics3D.wasm.wasm', '../' + build_path + '/js/libs/**/*.js', '!../' + build_path + '/js/declare/*ts'])
        .pipe(gulp.dest('../' + build_path + '/as/jslibs'));
});
...
gulp.task('CopyTSFileToTS', () => {
    return gulp.src([
        ...
        .pipe(gulp.dest('../' + build_path + '/ts_new/libs'));
});

//拷贝第三方库至ts库(未来在数组中补充需要的其他第三方库)
gulp.task('CopyTSJSLibsFileToTS', () => {
    return gulp.src([
        './layaAir/jsLibs/**/*.*', '../' + build_path + '/js/libs/laya.cannonPhysics.js'])
        .pipe(gulp.dest('../' + build_path + '/ts_new/jslibs'));
});


gulp.task('CopyDTS', (cb) => {
    gulp.src(['../tslibs/ts/*.*', './layaAir/glsl.d.ts'])
        .pipe(gulp.dest('../' + build_path + '/js/ts'))
        .pipe(gulp.dest('../' + build_path + '/ts/ts'))
...
gulp.task("compressJs", function () {
    gulp.src("../" + build_path + "/as/jslibs/laya.physics3D.js")
        .pipe(rename({ extname: ".min.js" }))
        .pipe(gulp.dest("../" + build_path + "/as/jslibs/min"))
        .pipe(gulp.dest("../" + build_path + "/js/libs/min"))
        .pipe(gulp.dest("../" + build_path + "/ts/libs/min"));

    gulp.src("../" + build_path + "/as/jslibs/laya.physics3D.wasm.wasm")
        .pipe(gulp.dest("../" + build_path + "/as/jslibs/min"))
        .pipe(gulp.dest("../" + build_path + "/js/libs/min"))
        .pipe(gulp.dest("../" + build_path + "/ts/libs/min"));

    return gulp.src(["../" + build_path + "/as/jslibs/*.js", "!../" + build_path + "/as/jslibs/{laya.physics3D.js}"])
        .pipe(uglify({
            mangle: {
                keep_fnames: true
            }
...
gulp.task("compresstsnewJs", function () {
    gulp.src("../" + build_path + "/ts_new/jslibs/{laya.physics3D.js,box2d.js}")
        .pipe(rename({ extname: ".min.js" }))
        .pipe(gulp.dest("../" + build_path + "/ts_new/jslibs/min"));

    gulp.src("../" + build_path + "/ts_new/jslibs/laya.physics3D.wasm.wasm")
        .pipe(gulp.dest("../" + build_path + "/ts_new/jslibs/min"));

    return gulp.src(["../" + build_path + "/ts_new/jslibs/*.js", "!../" + build_path + "/ts_new/jslibs/{laya.physics3D.js,box2d.js}"])
        .pipe(uglify({
            mangle: {
                keep_fnames: true
            }
